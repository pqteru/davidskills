...
description: DavidSkills performance and debugging module. Use for measured failures, regressions, or profiling-backed optimization.
---
...
4. When lifecycle or caching behavior is in scope, read applicable stack maintenance protocols (e.g. `../davidskills/protocols/php-maintenance-mode.md`)
